...
import type { ParsedPO } from '@/types'
import POForm from './POForm'

type Stage = 'upload' | 'parsing' | 'verify'

export default function POUploader() {
      ...
      <div>
        <div className="flex items-center gap-3 mb-6 p-4 bg-green-50 border border-green-200 rounded-lg">
          ...
          <div>
            ...
            <p className="text-sm text-green-600">Extracted from <strong>{fileName}</strong>. Review and edit before saving.</p>
          </div>
        </div>
        <POForm poType="client" parsedData={parsed} />
      </div>
    )
  }
  ...
  if (stage === 'parsing') {
    return (
      <div className="card card-body flex flex-col items-center justify-center py-20 gap-4">
        ...
        <p className="text-sm text-gray-500">Claude is extracting PO data from your document</p>
      </div>
    )
  }
  ...
  return (
    <div className="max-w-xl mx-auto">
      ...
      >
        ...
        <p className="text-lg font-semibold text-gray-700 mb-1">Drop your Purchase Order PDF here</p>
